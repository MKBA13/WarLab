  ...
  return (
    <>
      <Helmet>
        ...
        />
        <title>{_.i18n('WarLab')}</title>
        <meta name="title" content={_.i18n('WarLab')} />
        <meta name="description" content={_.i18n('DESC')} />
        <meta property="og:locale" content={lang} />
        <meta property="og:title" content={_.i18n('WarLab')} />
        <meta property="og:description" content={_.i18n('DESC')} />
        <meta name="twitter:title" content={_.i18n('WarLab')} />
